...
Afterwards, I have to find the best way to realize the communication enter the simulator and the plugin. After list all type of communication enter process with their advantages and their drawbacks, I decided to chose a socket communication.%, and send message only formatted as json object.
